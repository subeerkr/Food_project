    ...
    <Box sx={{ minHeight: "100vh", position: "relative" }}>
      ...
      <Box className="video-container" sx={{ position: "relative" }}>
        ...
        >
          ...
          >
            <span>
              Discover our carefully crafted menu featuring the finest
          ...
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body1" sx={{ mb: 2, color: "#333" }}>
                Discover <strong>SWAGAT FOODS</strong>, the newest addition to
                the city's dining scene. As a{" "}
                <strong>premium restaurant</strong> specializing in authentic
                Indian cuisine, we provide a<strong> unique experience</strong>{" "}
                with an incredible ambiance.
              </Typography>
              <Typography variant="body1" sx={{ color: "#333" }}>
                Ideal for a business lunch or a casual gathering with friends
                and family,
                <strong> SWAGAT FOODS</strong> pairs{" "}
                <strong>exceptional cuisine</strong> with stunning flavors.
              </Typography>
            </Grid>
          </Grid>
        </Container>
              ...
              <Grid item key={item.id} xs={12} sm={6} md={4}>
                <Card className="card-hover" sx={{ textAlign: "center" }}>
                  ...
                  <CardContent>
                    ...
                    <Typography
                      variant="h6"
                      sx={{ mb: 2, fontWeight: "bold", color: "#d4af37" }}
                    >
                      {item.price}
                    </Typography>
                    <Button
